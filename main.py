...
def menuAdmin():
    try:
        while True:
            ...
            user_input = input(colored("Please choose from the menu [1-10]: ", 'yellow', attrs=['bold'])).strip()
            if user_input == '1':
                assets.add_assets()
            ...
            elif user_input == '5' or 'Add User' in user_input.lower():
                data_analysis.display_data_in_graph()

            elif user_input == '6' or 'display All Users' in user_input:
                users.reg_new_admin()
            ...
            elif user_input == '10'  or user_input.lower() == 'exit' :
                 print(colored("Thanks For Using Mr.IT System 🩵 \n Stay Safe, See You Soon 👋", 'blue', attrs=['bold'])) 
                 break
    except Exception as e:
        print(f"Opss Error in menuAdmin check it out: {str(e)}")
...
def main():
    try:
        while True:
            ...
            if login_sign_up == '1':
                userName, password = input('Enter your username: '), input('Enter your password: ').lower()
        ...
        print(f"Opss Error in main check it out: {str(e)}")
